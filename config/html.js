              ...
              >
                <tr>
                  <td class="logo" style="text-align: center">
                    <h1><a href="#">${response ? "Amresh Kumar" : name}</a></h1>
                  </td>
                </tr>
              </table>
            </td>
                ...
                <tr>
                  ...
                  >
                    <div class="text">
                      ${
                        response
                          ? `<h3>Hey, ${name}, I have received your Email.</h3>`
                          : `<h3>From Company: ${
                              company ? company : "compnay name Empty"
                            }</h3>`
                      }
                    </div>
                  </td>
                  ...
                  <td style="text-align: center">
                   ${
                     response
                      ...
                      <h3 class="name"><a  href="tel:${phone}" >${phone}</a></h3>
        ...
        >
          <tr>
            <td valign="middle" class="bg_light footer email-section">
              <table>
                <tr>
                  <td valign="top" width="35%" style="padding-top: 20px">
                    <table
                      role="presentation"
                      cellspacing="0"
                      cellpadding="0"
                    ...
                    >
                      <tr>
                        <td style="text-align: left; padding-right: 10px">
                          ...
                          <p class="text">
                            I am a MERN Stack developer. I am proficient in
                      ...
                      <tr>
                        ...
                        >
                          ...
                          <ul>
                            <li>
                              <span class="text"
                                >Currently living in Banglore, Karnataka.</span
                              >
                            </li>
                            <li><a href="tel:+919535188512" class="text">+91 9535188512</a></li>
                          </ul>
                        </td>
                      </tr>
                    </table>
            ...
            <td class="bg_light" style="text-align: center">
              <p style="margin-top:0;">
                Link to my Portfolio &nbsp;<a
                  href="https://amresh-portfolio.netlify.app/"
                  target="_blank"
